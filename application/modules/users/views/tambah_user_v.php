...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <form class="form" action="proses_tambah_user" method="post">
                                    <div class="form-group">
                                        <label>Username</label>
                                        <input type="text" class="form-control" name="username" id="regular1" required autofocus>
                                    </div>
                                    <div class="form-group">
                                        <label>Password</label>
                                        <input type="password" class="form-control" name="password" id="regular1" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Level</label>
                                    ...
                                    <div class="form-group sales" id="sales" style="display: none;">
